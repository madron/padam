...
class CutListTest(unittest.TestCase):
    def test_material(self):
        ...
        self.assertEqual(lines[1], '1160,600,1,plywood_20,kitchen_top_panel,true,v')
        self.assertEqual(lines[2], '1160,600,1,plywood_20,kitchen_bottom_panel,true,v')
        self.assertEqual(lines[3], '700,600,1,plywood_20,kitchen_left_panel,true,v')
        self.assertEqual(lines[4], '700,600,1,plywood_20,kitchen_right_panel,true,v')
