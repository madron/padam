...
class CabinetTest(unittest.TestCase):
    ...
    def test_get_params(self):
        ...
        self.assertEqual(params[10], ('back_thickness', 20))
        self.assertEqual(params[11], ('back_material', 'plywood'))
        self.assertEqual(params[12], ('door_number', 2))
        self.assertEqual(params[13], ('door_thickness', 20))
        self.assertEqual(params[14], ('door_material', 'plywood'))
        self.assertEqual(params[15], ('door_offset', 3))
