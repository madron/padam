...
class CabinetTest(unittest.TestCase):
    ...
    def test_materials(self):
        cabinet = Cabinet(1000, 30, 18)
        self.assertEqual(len(cabinet.get_materials()), 5)
        self.assertEqual(cabinet.get_materials()[0]['part'].name, 'top_panel')
        self.assertEqual(cabinet.get_materials()[1]['part'].name, 'bottom_panel')
        self.assertEqual(cabinet.get_materials()[2]['part'].name, 'left_panel')
        self.assertEqual(cabinet.get_materials()[3]['part'].name, 'right_panel')
        self.assertEqual(cabinet.get_materials()[4]['part'].name, 'back_panel')

    def test_materials_1_door(self):
        cabinet = Cabinet(1000, 30, 18, door_number=1)
        self.assertEqual(len(cabinet.get_materials()), 6)
        self.assertEqual(cabinet.get_materials()[0]['part'].name, 'top_panel')
        self.assertEqual(cabinet.get_materials()[1]['part'].name, 'bottom_panel')
        self.assertEqual(cabinet.get_materials()[2]['part'].name, 'left_panel')
        self.assertEqual(cabinet.get_materials()[3]['part'].name, 'right_panel')
        self.assertEqual(cabinet.get_materials()[4]['part'].name, 'back_panel')
        self.assertEqual(cabinet.get_materials()[5]['part'].name, 'door_panel')

    def test_materials_2_doors(self):
        cabinet = Cabinet(1000, 30, 18, door_number=2)
        self.assertEqual(len(cabinet.get_materials()), 7)
        self.assertEqual(cabinet.get_materials()[0]['part'].name, 'top_panel')
        self.assertEqual(cabinet.get_materials()[1]['part'].name, 'bottom_panel')
        self.assertEqual(cabinet.get_materials()[2]['part'].name, 'left_panel')
        self.assertEqual(cabinet.get_materials()[3]['part'].name, 'right_panel')
        self.assertEqual(cabinet.get_materials()[4]['part'].name, 'back_panel')
        self.assertEqual(cabinet.get_materials()[5]['part'].name, 'left_door_panel')
        self.assertEqual(cabinet.get_materials()[6]['part'].name, 'right_door_panel')
